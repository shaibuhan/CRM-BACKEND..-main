...
exports.createTicket = async (req, res) => {
    ...
    try {
        ...
        if (!engineer) {
            // Handle case where no engineer is found
            console.log("No engineer found to assign the ticket.");
            return res.status(404).send({ message: "No engineer found to assign the ticket." });
        }
